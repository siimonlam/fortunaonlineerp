/*
  # Fix execute_project_automations Function Table Name
  
  1. Changes
    - Update table name from `project_statuses` to `statuses`
*/
  ...
  LOOP
    BEGIN
      ...
      ELSIF v_rule.action_type = 'add_task' THEN
        -- Add task (note: project_tasks table might be named 'tasks')
        INSERT INTO tasks (
          project_id,
          title,
          description,
