/*
  # Add Channel Partner ID to Client Onboarding Function

  1. Changes
    - Drop existing create_client_onboarding function
    - Create updated function with channel_partner_id parameter
  
  2. Purpose
    - Support channel partner assignment during client onboarding
*/

-- Drop old function
DROP FUNCTION IF EXISTS create_client_onboarding(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN, TEXT, TEXT, TEXT, UUID, TEXT, TEXT);
...
CREATE OR REPLACE FUNCTION create_client_onboarding(
  ...
  p_channel_partner_id UUID DEFAULT NULL
)
RETURNS UUID
LANGUAGE plpgsql
SECURITY DEFINER
