/*
  # Update Client Onboarding Function - Add Brand Name

  1. Changes
    - Drop existing function
    - Create updated function with brand_name parameter
    - Add brand_name to the INSERT statement
  
  2. Purpose
    - Support brand name input during client onboarding
*/

-- Drop old function
DROP FUNCTION IF EXISTS create_client_onboarding(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN, TEXT, TEXT);

-- Create updated function with brand_name
