...
import { Facebook, RefreshCw, Users, Share2, ExternalLink, Calendar, Settings, X, Save, Check, AlertCircle } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900">Facebook Pages</h3>
            <p className="text-sm text-gray-600">Manage and sync Facebook Business pages</p>
          </div>
        </div>
